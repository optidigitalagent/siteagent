...
For a Level B `micro_site`, a compact, verified offer → real-business-media proof → official-site conversion path is commercially complete when the evidence does not confirm a direct contact method, clinical process, prices, outcomes, or further decision content. Do not call such a page a “thin redirect,” require a secondary contact route, or score it below the delivery threshold merely for refusing to invent those facts. A CTA may name the visitor intent and explicitly state that it opens the verified official site. Raise a high issue only for a concrete failure of the bounded contract or a visible technical, copy, evidence, or UX defect; reserve stylistic refinements for medium or low issues.
